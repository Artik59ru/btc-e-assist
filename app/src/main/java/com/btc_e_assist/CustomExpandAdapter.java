...
public class CustomExpandAdapter extends BaseExpandableListAdapter {
     ...
     * @param groupLayout
     * @param childLayout
     * @param imageId        id for insert DrawableLeft
     * @param aliases        Array of aliases
     * @param aliasesDrawIds relative for aliases images
     */
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        for (int i = 0; i < mGroupTo.length; i++) {
            TextView v = (TextView) view.findViewById(mGroupTo[i]);
            if (v != null && currentAlias != null && mGroupTo[i] == mImageId) {
                for (int y = 0; y < mAliases.length; y++) {
